...
class MFDNN2(nn.Module):
    def __init__(self):
        ...
        self.net_high_non_linear = nn.Sequential()
        self.net_high_non_linear.add_module('layer_1', nn.Linear(4, 100))
        self.net_high_non_linear.add_module('layer_11', nn.Tanh())
        self.net_high_non_linear.add_module('layer_2', nn.Linear(100, 100))
        self.net_high_non_linear.add_module('layer_22', nn.Tanh())
        self.net_high_non_linear.add_module('layer_3', nn.Linear(100, 100))
        self.net_high_non_linear.add_module('layer_33', nn.Tanh())
        self.net_high_non_linear.add_module('layer_4', nn.Linear(100, 100))
        self.net_high_non_linear.add_module('layer_44', nn.Tanh())
        self.net_high_non_linear.add_module('layer_5', nn.Linear(100, 100))
        self.net_high_non_linear.add_module('layer_55', nn.Tanh())
        self.net_high_non_linear.add_module('layer_6', nn.Linear(100, 100))
        self.net_high_non_linear.add_module('layer_66', nn.Tanh())
        self.net_high_non_linear.add_module('layer_7', nn.Linear(100, 100))
        self.net_high_non_linear.add_module('layer_77', nn.Tanh())
        self.net_high_non_linear.add_module('layer_8', nn.Linear(100, 100))
        self.net_high_non_linear.add_module('layer_88', nn.Tanh())
        self.net_high_non_linear.add_module('layer_9', nn.Linear(100, 2))
        ...
        self.net_high_linear.add_module('layer_51', nn.Linear(100, 100))
        self.net_high_linear.add_module('layer_52', nn.Linear(100, 100))
        self.net_high_linear.add_module('layer_53', nn.Linear(100, 100))
        self.net_high_linear.add_module('layer_54', nn.Linear(100, 100))
